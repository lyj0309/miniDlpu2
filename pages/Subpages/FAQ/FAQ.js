...
Page({
    ...
    data: {
        ...
        FAQ: [{
            ...
            question: "可不可以添加一个xxx的功能？",
            answerArr: [
                [{
                    text: "如果大家有什么功能建议，可以在意见反馈说一说哈，只要学长们技术过关，一般能满足大家的；"
                },],
            ]
        }, {
            question: "可以在这个小程序里打广告或者公益宣传吗？",
            answerArr: [
                [{
                    text: "可以的，可以在综合信息页面上半部分图片轮播宣传，小程序目前用户数已达7.3千人，日活跃用户约3千人，日访问量3w+，是一个很好的宣传平台；"
                },],
                [{
                    text: "收费：公益项目、活动免费帮宣传；其他的需要联系开发者协商；"
                }], [{
                    text: "原则：只接受综合信息页图片宣传，不接受虚假、营销、反动非法宣传；"
                }]
            ]
        }, {
            question: "在线客服是真人吗？",
            answerArr: [
                [{
                    text: "目前在线客服是四位小姐姐呀，她们是无偿自愿为大家解答服务的，是工大最靓的仙女！目前人手不是很充足，若没能及时回复请耐心等待。"
                },],
            ]
        },]
